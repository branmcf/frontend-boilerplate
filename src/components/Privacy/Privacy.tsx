...
const effectiveDate = 'January 1st, 2024'
const updateDate = 'January 1st, 2024'

const Privacy = () => {
    return(
        <div className="container">
            <h1>Privacy Policy</h1>
            <p>Your privacy is important to us. It is {company}'s policy to respect your privacy and comply with any applicable law and regulation regarding any personal information we may collect about you, including across our website, <a href={url}>{url}</a>, and other sites we own and operate. </p>
            <p>This policy is effective as of {effectiveDate} and was last updated on {updateDate}. </p>
                ...
                <p>Support <br/> support@{company}.{tld} </p>
        </div>
    )
}
